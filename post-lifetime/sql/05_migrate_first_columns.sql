-- post-lifetime/sql/05_migrate_first_columns.sql
-- =============================================================================
...
-- (via 03_populate_post_lifetime.sql) can fill them.
--
-- ⚠️  This DELETES all rows from post_lifetime.  Run 03_populate_post_lifetime.sql
--    immediately after this script to re-insert with the new columns.
--
-- Run:
--   mysql -h 10.18.74.14 -P 9030 -u pau -p < post-lifetime/sql/05_migrate_first_columns.sql

...
#
# Compares thresholds: sessions_threshold_total (fixed 265s) vs sessions_tukey
# (per-user adaptive IQR).
#
# Usage:
#   Rscript session-analysis/session_distribution_fit.R
#   Rscript session-analysis/session_distribution_fit.R --sample 50000 --cores 8
# =============================================================================
...
data_dir     <- "data"
output_dir   <- "results"
tables       <- c("sessions_threshold_total", "sessions_tukey")
significance <- 0.05

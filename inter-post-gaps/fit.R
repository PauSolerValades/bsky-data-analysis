...
#                     (from pau_db.sessions_engagement, Tukey IQR, no likes)
#
# Data source: pau_db.engaged_events (post_top + post_reply) joined to
#              pau_db.sessions_engagement (deprecated tables user_core_events
#              and sessions_tukey are no longer used).
#
...
#
# Input:  data/inter_post_gaps.csv  (produced by extract.py)
# Output: results/inter_post_gap_fits.csv  (per-user distribution fits)
#
# Usage:
#   Rscript inter-post-gaps/fit.R
...
data_path    <- "inter-post-gaps/data/inter_post_gaps.csv"
output_dir   <- "inter-post-gaps/results"
significance <- 0.05
